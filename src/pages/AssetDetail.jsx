...
import { formatRupiah, formatPercent, formatDateID, parseRupiahInput, todayISO } from "../utils/format";
                ...
                return (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-xs text-on-surface-variant">{formatDateID(u.date)}</p>
                    </div>
                    {prev && (
                      <span
